...
url = "https://comic.naver.com/webtoon/list.nhn?titleId=724815&weekday=sat"
...
for cartoon_rating in cartoon_ratings:
    rate = cartoon_rating.find("strong").get_text()
    print(rate)
    total_rates += float(rate)

print("전체 점수 : ", total_rates)
print("평균 점수 : ", total_rates / len(cartoon_ratings))